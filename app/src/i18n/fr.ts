...
export const fr = {
  ...
  "itinerary.noTransit": "Aucun trajet en transports pour ce parcours — les horaires ne couvrent que l'Île-de-France.",
  "itinerary.noTransitSteps": "Aucun trajet en transports desservant toutes les étapes — les horaires ne couvrent que l'Île-de-France.",
  "itinerary.transitNote": "Horaires Île-de-France Mobilités, au départ de l'heure du calcul.",
