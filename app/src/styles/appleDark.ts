...
export const APPLE_DARK_STYLE = {
  ...
  "metadata": {
    "osm-local:derived-from": "OpenFreeMap Liberty, recoloré façon Apple Plans (sombre)"
  },
  ...
  "layers": [
    ...
    },
    {
      ...
      "paint": {
        "text-color": "#5f7c9e",
        "text-halo-color": "rgba(9,9,11,0.8)",
        "text-halo-width": 1.5
      }
    },
    {
