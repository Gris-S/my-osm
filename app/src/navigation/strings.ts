...
const fr = {
  ...
  "transit.ahead": "une étape d'avance sur l'horaire",
  "transit.aheadMany": "{count} étapes d'avance sur l'horaire",
  "transit.behind": "une étape de retard sur l'horaire",
  "transit.behindMany": "{count} étapes de retard sur l'horaire",
  "transit.resync": "Revenir à l'horaire",
...
const en: NavDict = {
  ...
  "transit.ahead": "one step ahead of schedule",
  "transit.aheadMany": "{count} steps ahead of schedule",
  "transit.behind": "one step behind schedule",
  "transit.behindMany": "{count} steps behind schedule",
  "transit.resync": "Back to the schedule",
